...
import { Button, Input, Combobox } from "../";
const ActionElement = Button;
const ValueEditor = Input;
const ValueSelector = Combobox;
...
export default class QueryBuilder extends React.Component {
  ...
  render() {
    ...
    return <RuleGroup translations={translations} rules={rules} combinator={combinator} schema={schema} id={id} parentId={null} />;
  }
